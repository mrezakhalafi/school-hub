                            ...
                            <div class="row g-3 align-items-end">
                                <div class="col-md-5">
                                    ...
                                    <input type="text" name="search" id="search" class="form-control"
                                        placeholder="Search by name, email, phone, relationship, or student..."
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="relationship" id="relationship" class="form-select">
                                        ...
                                        @foreach ($relationships as $relationshipOption)
                                            <option value="{{ $relationshipOption }}"
                                                {{ request('relationship') == $relationshipOption ? 'selected' : '' }}>
                                ...
                                <tbody>
                                    @forelse($parents as $index => $parent)
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-{{ $parent->relationship === 'father' ? 'primary' : ($parent->relationship === 'mother' ? 'info' : 'secondary') }}">
                                            ...
                                            <td>
                                                <a href="{{ route('students.show', $parent->student) }}"
