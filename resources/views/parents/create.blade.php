...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h1 class="h3 mb-4">Add New Parent</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="alert alert-info mt-4">
                                    <p class="mb-0"><i class="fas fa-info-circle"></i> <strong>Tip:</strong> You can add multiple parents for each student (e.g., both parents, or a parent and another guardian).</p>
                                </div>
                            </div>
                        </div>
