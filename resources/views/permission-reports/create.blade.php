    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3">Create Permission Report</h1>
                <a href="{{ route('permission-reports.index') }}" class="btn btn-secondary">Back to List</a>
            </div>

            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('permission-reports.store') }}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="permission_date" id="permission_date" class="form-control @error('permission_date') is-invalid @enderror" value="{{ old('permission_date') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="time" name="permission_time" id="permission_time" class="form-control @error('permission_time') is-invalid @enderror" value="{{ old('permission_time') }}" required>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <button type="submit" class="btn btn-primary">Create Permission Report</button>
                        </div>
                    </form>
                </div>
            </div>
