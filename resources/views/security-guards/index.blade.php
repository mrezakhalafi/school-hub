                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <div class="d-inline-block align-middle">
                            <h1 class="display-6 fw-bold text-dark mb-0">Security Guards (Satpam)</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card h-100 shadow-lg border-0 bg-gradient-to-br from-cyan-50 to-blue-50">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <p class="text-muted mb-1">Male Security Guards</p>
            ...
            <div class="col-md-6">
                <div class="card h-100 shadow-lg border-0 bg-gradient-to-br from-pink-50 to-rose-50">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <p class="text-muted mb-1">Female Security Guards</p>
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('security-guards.index') }}">
                            <div class="row g-3">
                                ...
                                <div class="col-md-2">
                                    <a href="{{ route('security-guards.index') }}" class="btn btn-outline-secondary w-100">Reset</a>
                                </div>
                                <div class="col-md-2">
                                    <a href="{{ route('security-guards.create') }}" class="btn btn-success w-100"><i
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    @forelse($securityGuards as $index => $guard)
                                        <tr>
                                            <td>{{ ($securityGuards->currentPage() - 1) * $securityGuards->perPage() + $index + 1 }}
                                            </td>
                                            <td>
                                                @if ($guard->profile_image)
                                                    <img src="{{ asset('storage/' . $guard->profile_image) }}"
                                                        alt="Profile" width="50" height="50" class="rounded-circle">
                                                @else
                                                    <img src="https://picsum.photos/100/100?random={{ $guard->id }}"
                                                        alt="Profile" width="50" height="50" class="rounded-circle">
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                <a href="{{ route('security-guards.show', $guard) }}"
                                                    class="btn btn-sm btn-info" title="View">
                                                    <i class="fas fa-eye"></i> View
                                                </a>
                                                <a href="{{ route('security-guards.edit', $guard) }}"
                                                    class="btn btn-sm btn-warning" title="Edit">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <a href="{{ route('security-guards.qr', $guard) }}"
                                                    class="btn btn-sm btn-primary" title="QR Code">
                                                    <i class="fas fa-qrcode"></i> QR
                                                </a>
                                                <button type="button" class="btn btn-sm btn-danger"
                                                    onclick="deleteGuard({{ $guard->id }})" title="Delete">
