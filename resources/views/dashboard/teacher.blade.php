        ...
        <div class="mb-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted">Manage your students and classroom activities.</p>
                </div>
            ...
            <div class="row g-4 mb-5">
                <div class="col-xl-4 col-md-6">
                    <a href="{{ route('students.index') }}" class="text-decoration-none">
                        <div class="card h-100 p-2 shadow-lg border-0 bg-gradient-to-br-blue-indigo">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h3 class="fw-bold mb-1 text-primary">Students</h3>
                ...
                <div class="col-xl-4 col-md-6">
                    <a href="{{ route('events.index') }}" class="text-decoration-none">
                        <div class="card h-100 p-2 shadow-lg border-0 bg-gradient-to-br-green-emerald">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h3 class="fw-bold mb-1 text-success">Events</h3>
                                        <p class="text-muted mb-0">View and manage school events</p>
                                    </div>
                                    <div class="p-3 rounded-circle bg-green-100 dashboard-card-icon">
                                        <i class="fas fa-calendar-alt text-success-green"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <a href="{{ route('teachers.index') }}" class="text-decoration-none">
                        <div class="card h-100 p-2 shadow-lg border-0 bg-gradient-to-br-indigo-purple">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h3 class="fw-bold mb-1 text-indigo">Teachers</h3>
                                        <p class="text-muted mb-0">View all teachers in school</p>
                                    </div>
                                    <div class="p-3 rounded-circle bg-indigo-100 dashboard-card-icon">
                                        <i class="fas fa-chalkboard-teacher text-indigo-purple"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <div class="d-flex flex-column gap-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="rounded-circle bg-danger me-3" style="width: 12px; height: 12px;">
                                        </div>
                                        <span class="text-muted">Absent</span>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <div class="rounded-circle bg-warning me-3" style="width: 12px; height: 12px;">
                                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
                    ...
                    for (let dayOfWeek = 0; dayOfWeek < 7; dayOfWeek++) {
                        ...
                        if ((week === 0 && dayOfWeek < firstDay)) {
                            ...
                            if (attendanceData[dayDateString]) {
                                ...
                                dayContent.title =
                                    `${attendanceData[dayDateString].status.charAt(0).toUpperCase() + attendanceData[dayDateString].status.slice(1)}`;
                            ...
                            dayContent.addEventListener('click', function() {
                                if (dayDate <= today) {
                                    ...
                                    document.getElementById('note').value = attendanceData[dayDateString]
                                        ?.note || '';
            ...
            function updateAttendanceStats() {
                ...
                Object.keys(attendanceData).forEach(date => {
                    ...
                    if (attendanceDate.getMonth() === currentMonth && attendanceDate.getFullYear() ===
                        currentYear) {
            ...
            document.getElementById('submit-attendance').addEventListener('click', function() {
                ...
                fetch('{{ route('attendance.store') }}', {
                    ...
                    .catch(error => {
                        ...
                        alert(
                            'An error occurred while submitting attendance. Please check the console for details.');
                    });
            });
