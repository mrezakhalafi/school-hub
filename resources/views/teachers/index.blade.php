                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <div class="d-inline-block align-middle">
                            <h1 class="display-6 fw-bold text-dark mb-0">Teachers</h1>
                        </div>
                    </div>
                            ...
                            <div class="row g-3 align-items-end">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="search" id="search" class="form-control"
                                        placeholder="Search by name, email, or class..." value="{{ request('search') }}">
                                </div>
                                <div class="col-md-3">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @forelse($teachers as $index => $teacher)
                                        <tr>
                                            <td>{{ ($teachers->currentPage() - 1) * $teachers->perPage() + $index + 1 }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @if ($teacher->class)
                                                    <a href="{{ route('classes.show', $teacher->class) }}"
