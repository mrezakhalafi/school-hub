                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('event_type') is-invalid @enderror" id="event_type" name="event_type" required>
                                        ...
                                        <option value="extracurricular" {{ old('event_type', $event->event_type) == 'extracurricular' ? 'selected' : '' }}>Extracurricular</option>
                                        <option value="sports" {{ old('event_type', $event->event_type) == 'sports' ? 'selected' : '' }}>Sports</option>
                                        <option value="arts" {{ old('event_type', $event->event_type) == 'arts' ? 'selected' : '' }}>Arts</option>
                                ...
                                <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input @error('is_published') is-invalid @enderror" 
                                           id="is_published" name="is_published" value="1" {{ old('is_published', $event->is_published) ? 'checked' : '' }}>
                                    ...
                                    @if($event->image)
                                        <div class="mt-2">
                                            ...
                                            <img src="{{ asset('storage/' . $event->image) }}" 
                                                 alt="Current Event Image" class="rounded" style="max-width: 200px; height: auto;">
                                            <div class="mt-2">
