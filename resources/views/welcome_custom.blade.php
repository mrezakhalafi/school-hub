            ...
            <div class="col-md-6 mx-auto">
                <div class="card shadow">
                    <div class="card-body p-5 text-center">
                        <p class="card-text">
                            @auth
                                <a href="{{ route('dashboard') }}" class="btn btn-primary btn-lg px-4">Dashboard</a>
                            @else
        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            SchoolHub is a comprehensive school management system designed to streamline educational
                            processes.
                            Our platform provides tools to manage students, teachers, classes, guardians, and events all in
                            one place.
                        </p>
                        <ul>
