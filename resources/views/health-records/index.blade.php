...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="display-6 fw-bold text-primary">Puskesmas Siswa</h1>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($record->medical_conditions && count($record->medical_conditions) > 0)
                                    <span class="badge bg-warning text-dark rounded-pill px-3 py-2">Needs Attention</span>
                                @else
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('health-records.show', $record) }}"><i class="fas fa-eye me-2"></i> View</a></li>
                                        <li><a class="dropdown-item" href="{{ route('health-records.edit', $record) }}"><i class="fas fa-edit me-2"></i> Edit</a></li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li>
                                            <form method="POST" action="{{ route('health-records.destroy', $record) }}" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="dropdown-item text-danger" onclick="return confirm('Are you sure you want to delete this health record?')">
