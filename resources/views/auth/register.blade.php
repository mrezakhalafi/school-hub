                    ...
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            <div class="mx-auto d-flex align-items-center justify-content-center mb-3"
                                style="width: 64px; height: 64px; background: linear-gradient(135deg, #10b981, #06b6d4); border-radius: 50%;">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="d-grid mb-4">
                                <button type="submit" class="btn btn-lg btn-primary shadow-sm"
                                    style="background: linear-gradient(135deg, #10b981, #06b6d4); border: none; padding: 12px 0; font-weight: 600; letter-spacing: 0.5px;">
                                    {{ __('Register') }}
                                </button>
                            </div>
